...
FOLLOW_UP = ['What else can I help you with?', 'Is there anything else  \n  you would like to know?', 'Do you have any other questions?']
...
class EnergySaverApp(App):
    def build(self):
        ...
        image1 = Image(source='images/chatbot4.png')
        ...
        self.advice_label.pos_hint = {'center_x': 0.67, 'center_y': 0.5} # adjust position as needed
        # Add the remaining widgets to the root widget
        self.category_input = TextInput(text="", multiline=False, font_size=50, halign='left', size_hint=(1, 0.1), height=40, background_color=(0.713, 0.576, 0.435, 1.0))
        ...
        self.help_label.pos_hint = {'center_x': 0.68, 'center_y': 0.34} # adjust position as needed
        home_button = Image(source='images/home.png', size_hint=(0.15, 0.15), size=(100, 50))
        home_button.pos_hint = {'center_x': 0.94, 'y': 0.17}
    ...
    def get_advice(self, *args):
        ...
        if any(greeting in user_input for greeting in ['hi', 'hello', 'hey']):
            ...
            if category:
                ...
                self.advice_label.text = "Sorry, I didn't understand.\n Please try again."
